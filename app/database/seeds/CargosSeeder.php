	...
	*/
	class CargosSeeder extends Seeder
	{
    	public function run(){
	        ...
	        Cargo::create(array('IdCargo' => '2','NombreCargo' => 'Ingeniero de Proyectos ','DescripcionCargo' =>''));
			...
			Cargo::create(array('IdCargo' => '7','NombreCargo' => 'Responsable Técnico de Laboratorio','DescripcionCargo' =>''));
			Cargo::create(array('IdCargo' => '8','NombreCargo' => 'Profesor Investigador ','DescripcionCargo' =>''));
			...
			Cargo::create(array('IdCargo' => '10','NombreCargo' => 'Ingeniero de Vinculación de Proyectos','DescripcionCargo'=>''));
			Cargo::create(array('IdCargo' => '11','NombreCargo' => 'Control y Presupuestos','DescripcionCargo'=>''));
			Cargo::create(array('IdCargo' => '12','NombreCargo' => 'Analista','DescripcionCargo'=>''));
			Cargo::create(array('IdCargo' => '13','NombreCargo' => 'Banco de Datos','DescripcionCargo'=>''));
			...
			Cargo::create(array('IdCargo' => '15','NombreCargo' => 'Contabilidad de Vinculados','DescripcionCargo'=>''));
			Cargo::create(array('IdCargo' => '16','NombreCargo' => 'Responsable de Activo Fijo','DescripcionCargo'=>''));

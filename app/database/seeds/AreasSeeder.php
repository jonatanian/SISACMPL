	...
	*/
	class AreasSeeder extends Seeder
	{
    	public function run(){
	        ...
	        Area::create(array('NombreArea' => 'Subdirección de Vinculación y Apoyo','DescripcionArea' => 'Ofertar los servicios del CMPL' ));
	        Area::create(array('NombreArea' => 'Departamento de Ingeniería de Procesos','DescripcionArea' => 'Ayudar a empresas a reducir residuos'));
	        Area::create(array('NombreArea' => 'Departamento de Ingeniería de Energía','DescripcionArea' => 'Ayudar a empresas a reducir residuos'));
